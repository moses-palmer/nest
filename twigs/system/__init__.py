...
@twig()
def main(me: Twig):
    me.run(*shlex.split(me.configuration.system.self_install()))


@main.checker
def is_installed(me: Twig) -> bool:
    return me.run(
        *shlex.split(me.configuration.system.self_check()),
        check=True,
        silent=True)
...
@main.remover
def remove(me: Twig):
    me.run(*shlex.split(me.configuration.system.self_remove()))
